...
export const style = {
    ...
    projectList: "grid grid-cols-1 lg:grid-cols-2 gap-5",
    project:
    ...
    logo: "rounded-full -mt-8 lg:-mt-10 h-16 lg:h-20 border-white border-solid border-4 absolute inset-x-1/2 -ml-8 lg:-ml-10",
    content: "px-3 mt-5",
